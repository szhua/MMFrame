 ...
 */
public abstract class BaseLoadMoreListAdapter extends RecyclerView.Adapter {
    public final static int LOAD_PROGRESSBAR_VIEW_TYPE = -1;
    protected BaseLoadMoreListFragment baseLoadMoreListFragment;

    public BaseLoadMoreListAdapter(BaseLoadMoreListFragment baseLoadMoreListFragment) {
...
//            loadFinish = (TextView) itemView.findViewById(R.id.loadfinish);
        ...
        public void changeState(int postion) {
            ...
            if (baseLoadMoreListFragment.haveMore()) {
//                loading.setVisibility(View.VISIBLE);
                baseLoadMoreListFragment.swipeRefreshLayout.setRefreshing(true);
                loadFinish.setVisibility(View.GONE);
            } else {
                loading.setVisibility(View.GONE);
